...
const NotesTab = ({
    ...
    // Extra safety in case a parent/API accidentally passes
        ...
        <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-4 mb-4 flex-shrink-0">
                ...
                {safeNotes.length > 0 && (
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2.5 bg-yellow-500 hover:bg-yellow-400 text-black rounded-xl font-black text-[10px] uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(234,179,8,0.3)]"
                    >
                        <FileText size={14} />
                        Export to PDF
                    </button>
            ...
            <div className="flex gap-3 mb-6 flex-shrink-0">
                ...
                <button
                    ...
                    className="px-6 bg-yellow-500 text-black rounded-xl hover:bg-yellow-400 transition-all disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed"
                >
                    <Send size={20} />
                </button>
            </div>
                ...
                {safeNotes.length > 0 ? (
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-yellow-500/30 transition-all flex flex-col gap-3">
                                    ...
                                    <div className="flex justify-between items-start gap-4">
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-1 bg-yellow-500/10 text-yellow-500 rounded-lg text-[10px] font-black flex items-center gap-1.5 hover:bg-yellow-500 hover:text-black transition-all flex-shrink-0"
                                        >
                                            <Clock size={12} />
                                        ...
                                        <button
                                            ...
                                            className="opacity-0 group-hover:opacity-100 p-1.5 text-gray-500 hover:text-rose-500 hover:bg-rose-500/10 rounded-lg transition-all flex-shrink-0"
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4 py-12">
                        ...
                        <p className="font-bold text-center">
                            No notes yet. Add one to save a specific
                            moment!
                        </p>
                    </div>
                )}
