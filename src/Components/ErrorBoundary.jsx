        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-950 transition-colors">
          <div className="max-w-md w-full p-10 glass-card rounded-[3rem] text-center space-y-8 border-2 border-rose-500/20 shadow-2xl shadow-rose-500/10">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl font-black font-outfit text-slate-900 dark:text-white">Something went wrong</h1>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a 
                href="/"
                className="w-full py-4 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2"
              >
